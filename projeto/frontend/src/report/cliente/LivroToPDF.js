            ...
            table: {
                    ...
                    body: [
                        [
                            ...
                            {text: 'Titulo', style: 'tableHeader', fontSize: 10, bold: true},
                            {text: 'Autor', style: 'tableHeader', fontSize: 10, bold: true},
                            {text: 'Editora', style: 'tableHeader', fontSize: 10, bold: true},
                            {text: 'Ano Publicação', style: 'tableHeader', fontSize: 10, bold: true},
                            {text: 'Estoque', style: 'tableHeader', fontSize: 10, bold: true},
                          ],
                        ...dados
                    ]
            },
