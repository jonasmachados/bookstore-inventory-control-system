...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        Livro livro1 = new Livro(null, "Harry Potter e a Pedra Filosofal", "J. K. Rowling", "Presenca", "link", formatador.parse("14/10/1999"));
        Livro livro2 = new Livro(null, "Don Quixote", "Miguel de Cervantes", "Livraria José Olympio Editora", "link",formatador.parse("01/01/1952"));
        Livro livro3 = new Livro(null, "Um Conto de Duas Cidades", "Charles Dickens", "	Bradbury & Evans", "link",formatador.parse("30/04/1859"));
        Livro livro4 = new Livro(null, "O Senhor dos Anéis", "J. R. R. Tolkien", "Allen & Unwin", "link", formatador.parse("20/10/1955"));
        Livro livro5 = new Livro(null, "O Pequeno Príncipe", "	Antoine de Saint-Exupéry", "Editora Agir", "link",formatador.parse("01/01/1956"));
